 ...
 */
public class SimCadProjectsViewSorter extends ViewerSorter
{
   ...
   public SimCadProjectsViewSorter(TableViewer viewer,
   ...
   public int compare(Viewer viewer, Object item1,
         Object item2) {
      for (int i = 0; i < infos.length; i++) {
         int result =
               infos[i].comparator.compare(item1, item2);
         if (result != 0) {
