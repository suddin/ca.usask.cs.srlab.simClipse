...
/**
 * The logger of convenience for the SimCad plug-in.
 */
public class SimCadLog {
   /**
   ...
   public static IStatus createStatus(int severity, int code, String message,
			Throwable exception) {
		return new Status(severity, SimCadActivator.PLUGIN_ID, code,
				message, exception);
	}
    ...
    */
	public static void log(IStatus status) {
		SimCadActivator.getDefault().getLog().log(status);
	}
}
