...
import ca.usask.cs.srlab.simclipse.ui.handler.DisplayCloneHandler;
...
public class ViewCloneActionDelegate implements IViewActionDelegate {
...
//					"Update Clone Index for project : " + project.getName());
			...
			DisplayCloneHandler handler = new DisplayCloneHandler();
			try {
