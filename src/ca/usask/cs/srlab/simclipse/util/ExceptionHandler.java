...
public class ExceptionHandler {
	...
	public static void log(Throwable t, String message) {
		SimClipseLog.log(new Status(IStatus.ERROR, SimClipsePlugin.PLUGIN_ID, IStatus.ERROR, message, t));
	}
	...
	public static void handle(CoreException e, String title, String message) {
		handle(e, SimClipsePlugin.getActiveWorkbenchShell(), title, message);
	}
	...
	public static void displayMessageDialog(Throwable t, String title, String message) {
		displayMessageDialog(t, SimClipsePlugin.getActiveWorkbenchShell(), title, message);
	}
	...
	private void displayMessageDialog(String exceptionMessage, Shell shell, String title, String message) {
		...
		if (exceptionMessage == null || exceptionMessage.length() == 0)
			msg.write("SimClipseMessages.ExceptionDialog_seeErrorLogMessage");
		else
