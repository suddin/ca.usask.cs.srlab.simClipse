...
import ca.usask.cs.srlab.simclipse.util.StringMatcher;

public class ProjectViewNameFilter extends ViewerFilter
{
   ...
   public ProjectViewNameFilter(StructuredViewer viewer) {
      this.viewer = viewer;
   }
   ...
   public boolean select(
      ...
      return matcher.match(
         ((IProjectViewItem) element).getName());
   }
