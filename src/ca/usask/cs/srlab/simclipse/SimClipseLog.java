...
/**
 * The logger of convenience for the SimClipse plug-in.
 */
public class SimClipseLog {
   /**
   ...
   public static IStatus createStatus(int severity, int code, String message,
			Throwable exception) {
		return new Status(severity, SimClipsePlugin.PLUGIN_ID, code,
				message, exception);
	}
    ...
    */
	public static void log(IStatus status) {
		SimClipsePlugin.getDefault().getLog().log(status);
	}
}
